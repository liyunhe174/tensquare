...
public class GatheringController {
	...
	public ResultVO findAll(){
		return new ResultVO(true,StatusCode.OK,"查询成功",gatheringService.findAll());
	}
	...
	public ResultVO findById(@PathVariable String id){
		return new ResultVO(true,StatusCode.OK,"查询成功",gatheringService.findById(id));
	}
	...
	public ResultVO findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new ResultVO(true,StatusCode.OK,"查询成功",  new PageResult<Gathering>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public ResultVO findSearch( @RequestBody Map searchMap){
        return new ResultVO(true,StatusCode.OK,"查询成功",gatheringService.findSearch(searchMap));
    }
	...
	public ResultVO add(@RequestBody Gathering gathering  ){
	...
	public ResultVO update(@RequestBody Gathering gathering, @PathVariable String id ){
		gathering.setId(id);
