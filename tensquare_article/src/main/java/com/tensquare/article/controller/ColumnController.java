...
public class ColumnController {
	...
	public ResultVO findAll(){
		return new ResultVO(true,StatusCode.OK,"查询成功",columnService.findAll());
	}
	...
	public ResultVO findById(@PathVariable String id){
		return new ResultVO(true,StatusCode.OK,"查询成功",columnService.findById(id));
	}
	...
	public ResultVO findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new ResultVO(true,StatusCode.OK,"查询成功",  new PageResult<Column>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public ResultVO findSearch( @RequestBody Map searchMap){
        return new ResultVO(true,StatusCode.OK,"查询成功",columnService.findSearch(searchMap));
    }
	...
	public ResultVO update(@RequestBody Column column, @PathVariable String id ){
		column.setId(id);
